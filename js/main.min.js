...
!function (e) {
  ...
  (t = function () {
    ...
    } else if (!0 === e.options.centerMode) o = e.slideCount;else if (e.options.asNavFor) for (; t < e.slideCount;) ++o, t = i + e.options.slidesToScroll, i += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;else o = 1 + Math.ceil((e.slideCount - e.options.slidesToShow) / e.options.slidesToScroll);
    return o - 1;
    ...
    var i,
      ...
      s,
      n = this;
    if (!0 === n.options.centerMode ? !0 === n.options.infinite ? s = (o = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (o = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), s = n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (o = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, s = Math.ceil(o + n.options.slidesToShow), !0 === n.options.fade && (o > 0 && o--, s <= n.slideCount && s++)), i = n.$slider.find(".slick-slide").slice(o, s), "anticipated" === n.options.lazyLoad) for (var r = o - 1, l = s, a = n.$slider.find(".slick-slide"), d = 0; d < n.options.slidesToScroll; d++) r < 0 && (r = n.slideCount - 1), i = (i = i.add(a.eq(r))).add(a.eq(l)), r--, l++;
    ...
    var e,
      ...
      r = o.length;
    for (e = 0; e < r; e++) if ("object" == _typeof(s) || void 0 === s ? o[e].slick = new t(o[e], s) : i = o[e].slick[s].apply(o[e].slick, n), void 0 !== i) return i;
    return o;
  };
}), function (e, t) {
  ...
  return function (e) {
    ...
    e.exports = {
      init: function init(e) {
        ...
        return function (e) {
          ...
          m(!0);
        }), window.addEventListener("resize", (0, l["default"])(m, v.debounceDelay, !0)), window.addEventListener("orientationchange", (0, l["default"])(m, v.debounceDelay, !0)), window.addEventListener("scroll", (0, r["default"])(function () {
          (0, c["default"])(f, v.once);
        }, v.throttleDelay)), v.disableMutationObserver || (0, a["default"])("[data-aos]", g), f);
      },
      refresh: m,
      refreshHard: g
    };
    ...
    (function (t) {
      ...
      function i(e, t, i) {
        function s(t) {
          var i = u,
            o = f;
          return u = f = void 0, y = t, v = e.apply(o, i);
        }
        function r(e) {
          return y = e, m = setTimeout(d, t), S ? s(e) : v;
        }
        function a(e) {
          var i = e - g;
          return void 0 === g || i >= t || i < 0 || T && e - y >= h;
        }
        function d() {
          var e = b();
          return a(e) ? c(e) : void (m = setTimeout(d, function (e) {
            var i = t - (e - g);
            return T ? k(i, h - (e - y)) : i;
          }(e)));
        }
        function c(e) {
          return m = void 0, $ && u ? s(e) : (u = f = void 0, v);
        }
        function p() {
          var e = b(),
            i = a(e);
          if (u = arguments, f = this, g = e, i) {
            ...
            if (T) return m = setTimeout(d, t), s(g);
          }
        ...
        return t = n(t) || 0, o(i) && (S = !!i.leading, h = (T = "maxWait" in i) ? w(n(i.maxWait) || 0, t) : h, $ = "trailing" in i ? !!i.trailing : $), p.cancel = function () {
          void 0 !== m && clearTimeout(m), y = 0, u = g = f = m = void 0;
        }, p.flush = function () {
      ...
      function n(e) {
        ...
        e = e.replace(c, "");
        var i = u.test(e);
        return i || f.test(e) ? h(e.slice(2), i ? 2 : 8) : p.test(e) ? a : +e;
      }
    ...
    (function (t) {
      ...
      function s(e) {
        ...
        e = e.replace(d, "");
        var s = p.test(e);
        return s || u.test(e) ? f(e.slice(2), s ? 2 : 8) : c.test(e) ? l : +e;
      }
      ...
      e.exports = function (e, t, o) {
        ...
        function l(e) {
          return b = e, m = setTimeout(d, t), S ? n(e) : v;
        }
        function a(e) {
          var i = e - g;
          return void 0 === g || i >= t || i < 0 || T && e - b >= h;
        }
        function d() {
          var e = k();
          return a(e) ? c(e) : void (m = setTimeout(d, function (e) {
            var i = t - (e - g);
            return T ? w(i, h - (e - b)) : i;
          }(e)));
        }
        function c(e) {
          return m = void 0, $ && u ? n(e) : (u = f = void 0, v);
        }
        function p() {
          var e = k(),
            i = a(e);
          if (u = arguments, f = this, g = e, i) {
            if (void 0 === m) return l(g);
            if (T) return m = setTimeout(d, t), n(g);
          }
          return void 0 === m && (m = setTimeout(d, t)), v;
        }
        var u,
        ...
        return t = s(t) || 0, i(o) && (S = !!o.leading, h = (T = "maxWait" in o) ? y(s(o.maxWait) || 0, t) : h, $ = "trailing" in o ? !!o.trailing : $), p.cancel = function () {
    ...
    t["default"] = function (e, t) {
      var s = window.document,
        n = new (window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver)(i);
    ...
    var o = function () {
      ...
      a = function () {
        ...
        return o(e, [{
          ...
          value: function value() {
            var e = i();
            return !(!r.test(e) && !l.test(e.substr(0, 4)));
          }
        }, {
          key: "tablet",
          value: function value() {
...
var portfolioContainer = document.querySelector(".portfolio"),
  portfolioButton = document.getElementById("portfolio-show"),
  portfolioHiddens = document.querySelectorAll("#portfolio-hidden");
function dropdown() {
  document.getElementById("myDropdown").classList.toggle("show"), document.querySelector(".dropdown__arrow").classList.toggle("opened");
}
function dropdownMob() {
  document.getElementById("myDropdownMob").classList.toggle("show"), document.querySelector(".arrow__mob").classList.toggle("opened");
}
portfolioButton.addEventListener("click", function (e) {
  portfolioHiddens.forEach(function (e) {
    e.classList.toggle("hidden");
  }), portfolioButton.classList.toggle("hidden"), portfolioContainer.classList.toggle("more-items");
  ...
  if (!e.target.matches(".dropbtn")) {
    ...
    for (t = 0; t < i.length; t++) {
      var o = i[t];
      o.classList.contains("show") && (o.classList.remove("show"), document.querySelector(".dropdown__arrow").classList.toggle("opened"));
    }
  }
};
var blogButton = document.getElementById("blog-show"),
  blogHiddens = document.querySelectorAll("#blog__hidden");
blogButton.addEventListener("click", function (e) {
  blogHiddens.forEach(function (e) {
    e.classList.toggle("hidden");
  }), blogButton.classList.toggle("hidden");
});
var burgerBtn = document.getElementById("mobile-menu"),
  burgerMiddle = document.querySelector(".header__mob-menu-burger"),
  headerContainer = document.querySelector(".header__mob");
function onEntry(e) {
...
burgerBtn.addEventListener("click", function (e) {
  burgerBtn.classList.toggle("active"), burgerMiddle.classList.toggle("active"), headerContainer.classList.toggle("active"), document.body.classList.toggle("fixed");
}), AOS.init();
var options = {
    threshold: [.5]
  },
