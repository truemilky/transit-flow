...
portfolioButton.addEventListener("click", function (i) {
  portfolioHiddens.forEach(function (i) {
...
blogButton.addEventListener("click", function (i) {
  blogHiddens.forEach(function (i) {
    i.classList.toggle("hidden");
...
burgerBtn.addEventListener("click", function (i) {
