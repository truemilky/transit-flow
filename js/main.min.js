  ...
  (i = function () {
    ...
    return function (t, o) {
      ...
      n.defaults = {
        ...
        centerPadding: "50px",
        cssEase: "ease",
        customPaging: function customPaging(i, t) {
    ...
    if (!0 === e.options.infinite) {
      if (e.slideCount <= e.options.slidesToShow) ++o;else for (; i < e.slideCount;) ++o, i = t + e.options.slidesToScroll, t += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;
    } else if (!0 === e.options.centerMode) o = e.slideCount;else if (e.options.asNavFor) for (; i < e.slideCount;) ++o, i = t + e.options.slidesToScroll, t += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;else o = 1 + Math.ceil((e.slideCount - e.options.slidesToShow) / e.options.slidesToScroll);
    return o - 1;
    ...
    var i,
      ...
      r = this,
      l = !1;
    if ("object" === e.type(arguments[0]) ? (o = arguments[0], l = arguments[1], n = "multiple") : "string" === e.type(arguments[0]) && (o = arguments[0], s = arguments[1], l = arguments[2], "responsive" === arguments[0] && "array" === e.type(arguments[1]) ? n = "responsive" : void 0 !== arguments[1] && (n = "single")), "single" === n) r.options[o] = s;else if ("multiple" === n) e.each(o, function (e, i) {
      r.options[e] = i;
    ...
    var o,
      ...
      d = null,
      a = this;
    if (i = i || !1, !(!0 === a.animating && !0 === a.options.waitForAnimate || !0 === a.options.fade && a.currentSlide === e)) if (!1 === i && a.asNavFor(e), o = e, d = a.getLeft(o), r = a.getLeft(a.currentSlide), a.currentLeft = null === a.swipeLeft ? r : a.swipeLeft, !1 === a.options.infinite && !1 === a.options.centerMode && (e < 0 || e > a.getDotCount() * a.options.slidesToScroll)) !1 === a.options.fade && (o = a.currentSlide, !0 !== t ? a.animateSlide(r, function () {
      a.postSlide(o);
    }) : a.postSlide(o));else if (!1 === a.options.infinite && !0 === a.options.centerMode && (e < 0 || e > a.slideCount - a.options.slidesToScroll)) !1 === a.options.fade && (o = a.currentSlide, !0 !== t ? a.animateSlide(r, function () {
      a.postSlide(o);
    }) : a.postSlide(o));else {
    ...
    var e,
      ...
      r = o.length;
    for (e = 0; e < r; e++) if ("object" == _typeof(s) || void 0 === s ? o[e].slick = new i(o[e], s) : t = o[e].slick[s].apply(o[e].slick, n), void 0 !== t) return t;
    return o;
  };
});
...
var numberOne = document.querySelector(".number-1"),
  ...
  startOne = +numberOne.innerHTML,
  endOne = +numberOne.dataset.max;
window.addEventListener("scroll", function e() {
  if (window.pageYOffset > numberOneTop - window.innerHeight / 2) {
    this.removeEventListener("scroll", e);
    var i = setInterval(function () {
      numberOne.innerHTML = ++startOne, startOne == endOne && clearInterval(i);
    }, 1);
  }
});
...
window.addEventListener("scroll", function e() {
  if (window.pageYOffset > numberTop - window.innerHeight / 2) {
    this.removeEventListener("scroll", e);
    var i = setInterval(function () {
      number.innerHTML = ++start, start == end && clearInterval(i);
    }, 2);
  }
});